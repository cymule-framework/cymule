...
| Agent Interaction | Partial | typed Session updates, M1-backed replay, atomic durable input waits, binding-pinned host occurrences, receipt-loss redispatch prevention, and model-tool-model loop; occurrence recovery and protocol adapters remain |
