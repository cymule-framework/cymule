...
pub use model::{
    ...
    RESOURCE_LOCATOR_VERSION, RESOURCE_MEDIA_TYPE_PATTERN, RESOURCE_VERSION, ResourceCandidate,
    ResourceHandle, ResourceIntegrity, ResourceLocation, ResourceLocatorSet, ResourcePublication,
    ...
    resource_handle_artifact_schema, validate_resource_media_type,
};
pub use resolver::{
